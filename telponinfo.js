...
const PAGINATION_URL_PREFIX = "http://telpon.info/distributor-produk-makanan/jakarta/page-"
...
function extractData(htmlString, paging) {
	...
	*/
	...
	dataBlocks.map((_idx, domDataBlock) => {
		...
		extractedData.push({ companyName, address, phone, locationA })
	})
	
	extractedData.forEach(({ companyName, address, phone, locationA }) => {
		writer.write([companyName, address, phone, locationA])
	})
